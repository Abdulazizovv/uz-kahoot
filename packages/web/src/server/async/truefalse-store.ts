...
const testsDir = () => getConfigPath("truefalse/tests")
const resultsDir = () => getConfigPath("truefalse/results")
const telegramFile = () => getConfigPath("truefalse/telegram.json")

export const initTrueFalseStore = () => {
  ensureDir(getConfigPath("truefalse"))
  ensureDir(testsDir())
