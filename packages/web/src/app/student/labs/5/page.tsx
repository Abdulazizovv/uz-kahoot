        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          <div className="mb-8 rounded-2xl border-2 border-indigo-200 bg-gradient-to-r from-indigo-600 to-purple-600 p-8 shadow-lg">
            ...
            <p className="text-lg text-indigo-100">
              Ampermetr va voltmetr yordamida murakkab elektr zanjirlarda
              Kirxgof qonunlarini eksperimental tekshirish
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 p-6 shadow-md">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                <strong>Kirxgofning 1-qonuni</strong> – zanjirning biror
                tuguniga kirayotgan toklarning algebraik yig'indisi nolga teng.
                Bu qonun zaryad saqlanish qonunining natijasi.
              </p>
              <p>
                <strong>Kirxgofning 2-qonuni</strong> – elektr zanjirining
                ixtiyoriy yopiq konturida barcha EYuKlarning algebraik
                yig'indisi shu konturdagi kuchlanish tushishlarining
                yig'indisiga teng.
              </p>
